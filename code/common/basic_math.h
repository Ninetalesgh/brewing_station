...
//actual values vs best values floats can give us:
//                     |1.5707963|2679..
...
struct int2
{
  ...
  INLINE bool2 friend operator<( int2 const& a, int2 const& b ) { return { a.x < b.x, a.y < b.y }; }
  INLINE bool2 friend operator>( int2 const& a, int2 const& b ) { return { a.x > b.x, a.y > b.y }; }
...
struct float2
{
  ...
  INLINE bool2 friend operator<( float2 const& a, float2 const& b ) { return { a.x < b.x, a.y < b.y }; }
  INLINE bool2 friend operator>( float2 const& a, float2 const& b ) { return { a.x > b.x, a.y > b.y }; }
