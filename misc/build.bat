...
:build_develop
  ...
  cl     %codepath%\brewing_station_platform.cpp /Fe:brewing_station.exe %compiler_options_dev% %linker_options% 
...
:build_release
  ...
  cl %codepath%\brewing_station_platform.cpp /Fe:brewing_station.exe %compiler_options_release% %linker_options% 
  echo ------------------------------------
